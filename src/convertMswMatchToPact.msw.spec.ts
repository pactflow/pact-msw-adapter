...
import type { MatchedRequest, PactFile } from "./pactMswAdapter.ts";
  ...
  it("should convert an msw server match to a pact", async () => {
    expect(
      await convertMswMatchToPact({
        // biome-ignore lint/suspicious/noExplicitAny: MSW HttpResponse is not assignable to Response at the type level
